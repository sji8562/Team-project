...
public class Company {
    ...
    private int level;
    @Builder
    public Company(Integer index,String companyId, String companyName, String password, String email, String picUrl,String phoneNum,String address, String addressDetail, String homepage , Integer establishment , String businessNum, int level) {
        this.index = index;
